...
urlpatterns = [
    ...
    path("inspect_process_2nd/<str:task_num>/<str:work_type>/final_complete_inspect2", inspect_views_2nd.final_complete_inspect2, name ='final_complete_inspect2 '),
    ...
    path("re_inspect_process_2nd/<str:task_num>/<str:work_type>/final_complete_inspect2", inspect_views_2nd.final_complete_inspect2, name ='final_complete_inspect2'),
