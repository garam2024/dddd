...
class Inspect_process(TemplateView):
    ...
    def post(self, request, task_num, work_type, *args, **kwargs):
        ...
        compare_result = InspectAdapter_1st().get_compare_result(request, task_num)
        ...
        if inspect_permission:
            ...
            if compare_result:
                ...
                # InspectAdapter_1st().mirror_db(request, task_num)
                ...
                if get_message == 'True' and get_message_2 == '4':
                    ...
                    task_info_list = InspectAdapter_1st().get_inspect_info(request, user_name, task_num)
...
class Re_Inspect_process(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        print("Re Inspect_process_1st get")
        print(request)
...
def inspect_middle_cancel_module(request, task_num):
    ...
    if request.method == "POST" :
        ...
        get_message = str(InspectAdapter_1st().inspect_middle_cancel(request, task_num))
