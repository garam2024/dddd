        ...
        if(bboxData.images.length <= indexValue || indexValue < 0 ){
            ...
            for(var i = 0; i < bboxData.labels.length; i++){
                if(bboxData.labels[i].associatedImage === bboxData.images[indexValue].id){
                    ...
                    str += `<strong>label${num} </strong>`;
                    str += "</div>";
                    str += "<select name='label-box-occupantId' class='label-box-occupantId' id='label-box-occupantId" + num + "' onchange='labeler.changeDataKinds(" + num + ")' disabled>";
                    str += "<option value='' >선택</option>";
                    ...
                    str += "</select>";
                    str += "<select name='label-box-data' class='label-box-data' id='label-box-data" + num + "' onchange='labeler.callFunction(" + num + ")' disabled>";
                    str += "<option value=''>선택</option>";
                    for(var key in dataMap){
                    ...
                    str += "</select>";
                    str += "<select name='label-box-emotion' class='label-box-emotion' id='label-box-emotion" + num + "' onchange='labeler.saveLabeledData(" + num + ")' disabled>";
                    str += "<option value=''>선택</option>";
                    for(var key in emotionMap){
                    ...
                    str += "</select>";
                    str += "<select name='label-box-action' class='label-box-action' id='label-box-action" + num + "' onchange='labeler.saveLabeledData(" + num + ")' disabled>";
                    str += "<option value=''>선택</option>";
                    for(var key in actionMap){
                        if(bboxData.labels[i].labeledData.dataValue === key){
