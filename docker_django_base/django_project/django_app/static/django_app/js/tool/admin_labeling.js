...
//         labelSelectBox.classList.toggle('active')
//         if(e.target.nodeName === 'LI'){
...
//         let path = projectJsonData.path + (num + 1) + '.' + projectJsonData.type
...
//             if(this.projectJsonData.images[i].completedImage){
...
//     function left(){
//         if(nowPage <= start) return alert('첫번째 이미지입니다.')
//         nowPage--
//         nowPageMark.innerText = nowPage
//         inputPage.setAttribute('placeholder', nowPage)
//         createCanvas.pageLoad(nowPage - 1)
...
//     function right(){
//         if(nowPage >= imagesLength) return alert('마지막 이미지입니다.')
//         nowPage++
//         nowPageMark.innerText = nowPage
//         inputPage.setAttribute('placeholder', nowPage)
//         createCanvas.pageLoad(nowPage - 1)
...
//         url_check = window.location.pathname.split('/')[2]
//         url_check = url_check.replace('"','')

//         console.log("URL CHECK : ", url_check)

//         if (url_check == 'adminTaskCheck') {
...
//         if (url_check == 'adminInspectCheck') {

//             $.ajax({
//                 type: 'POST',
//                 url: 'inspect_check_api',
//                 data: imageId,
//                 success: function(data){
//                     console.log(data)
//                     let strArr = data.split('&')
...
//             checkButton.textContent = '보류'
//             normalButton.textContent = '포기'
//         }
//     })//jsonDataToserverBtn
