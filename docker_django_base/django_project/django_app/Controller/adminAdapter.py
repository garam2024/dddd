...
||||||| .r259
            task_ready_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'A'})
=======
            task_ready_list = sql_query.select_workList(table_name="django_app_worklist",
                                                        data_dic={'work_status': dbinfo.status['status_work_deagi']})
>>>>>>> .r284
            task_ready_len = len(task_ready_list)
        except:
            raise
...
||||||| .r259
            task_working_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'B'})
=======
            task_working_list = sql_query.select_workList(table_name="django_app_worklist",
                                                          data_dic={'work_status': dbinfo.status['status_work_run']})
>>>>>>> .r284
            task_working_len = len(task_working_list)
        except:
            raise
...
||||||| .r259
            inspect1_ready_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'C'})
=======
            inspect1_ready_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={
                'work_status': dbinfo.status['status_1cha_inspect_deagi']})
>>>>>>> .r284
            inspect1_ready_len = len(inspect1_ready_list)
        except:
            raise
...
||||||| .r259
            inspect1_working_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'D'})
=======
...
||||||| .r259
            inspect2_ready_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'E'})
=======
...
||||||| .r259
            inspect2_working_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'F'})
=======
...
||||||| .r259
            inspect3_ready_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'G'})
=======
...
||||||| .r259
            inspect3_working_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'H'})
=======
            inspect3_working_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={
                'work_status': dbinfo.status['status_3cha_inspect_run']})
>>>>>>> .r284
            inspect3_working_len = len(inspect3_working_list)
        except:
            raise
...
||||||| .r259
            task_complete_list = sql_query.select_workList(table_name="django_app_worklist", data_dic={'work_status':'I'})
=======
            task_complete_list = sql_query.select_workList(table_name="django_app_worklist",
                                                           data_dic={'work_status': dbinfo.status['status_complet']})
>>>>>>> .r284
            task_complete_len = len(task_complete_list)
        except:
            raise
...
||||||| .r259
            get_all_task = sqlMethodClass.select_workList(table_name="django_app_worklist", data_dic={'1':'1'}, status_list={"C", "R1", "R2", "R3"}, column_list=column_list, option=" order by work_id desc")
=======
    ...
    def get_current_process(self, request, data_dic=None):
        ...
        if data_dic == None:
            ...
            if data_dic['workerNm'] != '':
                ...
                option = option + "and reg_date BETWEEN TO_TIMESTAMP('" + data_dic[
                    'searchBgn'] + "', 'YYYY-MM-DD') AND TO_TIMESTAMP('" + data_dic[
                             'searchEnd'] + "', 'YYYY-MM-DD')  + interval '1 day'"
