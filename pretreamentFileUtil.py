        ...
        for work_id, workerDir in workList[job_id].items():
            ...
            for filework in file_list_mp4:
                if work_id == 'tbit': # 으뜸
                    ...
                    if len(bcpf_file_list)>1:
                        ...
                        for bcf_file in bcpf_file_list:
                            ...
                            if fileCnt == 0 :
                                ...
                                print("1번외 bcpf 파일 복사 및 삭제: %s" % (targetFilename) )
                        ...
                        #xml파일저장
                        xml_new_file = workerDir + "/bcpf/" + (filework.split(".mp4", ".bcpf"))
                    ...
                    ssh_manager.send_file(workerDir + "/mp4/" + filework , jobScplist[work_id]['bts'] + server_type_path + '/'+work_id+'/' + filework )  # 파일전송
